...
::orch "kubernetes" "IngressTLS" as IngressTLS @hosts, @secretName {
     /**Hosts are a list of hosts included in the TLS certificate. The values in this list must
      match the name/s used in the tlsSecret. Defaults to the wildcard host setting for the loadbalancer
