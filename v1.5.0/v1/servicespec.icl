...
::orch "kubernetes" "ServiceSpec" as ServiceSpec @loadBalancerIP, @deprecatedPublicIPs, @externalIPs, @loadBalancerSourceRanges, @selector, @externalName, @clusterIP, @sessionAffinity, @type, @ports {
     ...
     /**deprecatedPublicIPs is deprecated and replaced by the externalIPs field with almost the
      exact same semantics.  This field is retained in the v1 API for compatibility until at
      least 8/20/2016.  It will be removed from any new API revisions.  If both deprecatedPublicIPs
      *and* externalIPs are set, deprecatedPublicIPs is used.*/
     deprecatedPublicIPs = null,
     /**externalIPs is a list of IP addresses for which nodes in the cluster will also accept traffic
      ...
      that are not part of the Kubernetes system.  A previous form of this functionality exists
      as the deprecatedPublicIPs field.  When using this field, callers should also clear the
      deprecatedPublicIPs field.*/
     externalIPs = null,
     /**If specified and supported by the platform, this will restrict traffic through the cloud-provider
      load-balancer will be restricted to the specified client IPs. This field will be ignored
      if the cloud-provider does not support the feature." More info: http://kubernetes.io/docs/user-guide/services-firewalls*/
     ...
     /**Route service traffic to pods with label keys and values matching this selector. If empty
      ...
      Ignored if type is ExternalName. More info: http://kubernetes.io/docs/user-guide/services#overview*/
     selector = null,
     ...
     /**clusterIP is the IP address of the service and is usually assigned randomly by the master.
      ...
      ClusterIP, NodePort, and LoadBalancer. Ignored if type is ExternalName. More info: http://kubernetes.io/docs/user-guide/services#virtual-ips-and-service-proxies*/
     clusterIP = null,
     /**Supports "ClientIP" and "None". Used to maintain session affinity. Enable client IP based
      session affinity. Must be ClientIP or None. Defaults to None. More info: http://kubernetes.io/docs/user-guide/services#virtual-ips-and-service-proxies*/
     ...
     /**type determines how the Service is exposed. Defaults to ClusterIP. Valid options are ExternalName,
      ...
      routes to the clusterIP. More info: http://kubernetes.io/docs/user-guide/services#overview*/
     type = null,
