...
::orch "kubernetes" "PodAntiAffinity" as PodAntiAffinity @requiredDuringSchedulingIgnoredDuringExecution, @preferredDuringSchedulingIgnoredDuringExecution {
     /**NOT YET IMPLEMENTED. TODO: Uncomment field once it is implemented. If the anti-affinity
      ...
      be satisfied. RequiredDuringSchedulingRequiredDuringExecution []PodAffinityTerm  `json:"requiredDuringSchedulingRequiredDuringExecution,omitempty"`
     ...
     /**The scheduler will prefer to schedule pods to nodes that satisfy the anti-affinity expressions
      ...
      anti-affinity expressions, etc.), compute a sum by iterating through the elements of this
      field and adding "weight" to the sum if the node has pods which matches the corresponding
