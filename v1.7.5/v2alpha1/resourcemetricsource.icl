/**ResourceMetricSource indicates how to scale on a resource metric known to Kubernetes, as
 ...
 CPU or memory).  The values will be averaged together before being compared to the target.
 ...
 be set.*/
::orch "kubernetes" "ResourceMetricSource" as ResourceMetricSource @targetAverageUtilization, @name, @targetAverageValue {
