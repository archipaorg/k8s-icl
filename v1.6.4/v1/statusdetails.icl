...
::orch "kubernetes" "StatusDetails" as StatusDetails @kind, @group, @name, @retryAfterSeconds, @causes {
     /**The kind attribute of the resource associated with the status StatusReason. On some operations
      may differ from the requested resource Kind. More info: http://releases.k8s.io/HEAD/docs/devel/api-conventions.md#types-kinds*/
     kind = null,
