...
::orch "kubernetes" "PodSpec" as PodSpec @dnsPolicy, @serviceAccountName, @schedulerName, @hostNetwork, @restartPolicy, @hostIPC, @automountServiceAccountToken, @securityContext, @nodeName, @hostname, @serviceAccount, @nodeSelector, @activeDeadlineSeconds, @terminationGracePeriodSeconds, @affinity, @containers, @volumes, @tolerations, @subdomain, @initContainers, @imagePullSecrets, @hostPID {
     ...
     /**List of initialization containers belonging to the pod. Init containers are executed in
      ...
      be added or removed. Cannot be updated. More info: http://kubernetes.io/docs/user-guide/containers*/
     initContainers = null,
