...
The contents of the target Secret's Data field will be presented
 in a volume as files using the keys in the Data field as the file names. Secret volumes
 support ownership management and SELinux relabeling.*/
::orch "kubernetes" "SecretVolumeSource" as SecretVolumeSource @items, @defaultMode, @secretName {
     /**If unspecified, each key-value pair in the Data field of the referenced Secret will be projected
      ...
      will error. Paths must be relative and may not contain the '..' path or start with '..'.*/
     items = null,
