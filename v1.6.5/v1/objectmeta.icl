...
::orch "kubernetes" "ObjectMeta" as ObjectMeta @name, @deletionTimestamp, @clusterName, @deletionGracePeriodSeconds, @labels, @namespace, @finalizers, @generation, @generateName, @resourceVersion, @ownerReferences, @creationTimestamp, @annotations, @selfLink, @uid {
     ...
     /**DeletionTimestamp is RFC 3339 date and time at which this resource will be deleted. This
      ...
      API. In the presence of network partitions, this object may still exist after this timestamp,
      until an administrator or automated process can determine the resource is fully terminated.
      If not set, graceful deletion of the object has not been requested.

     Populated by the system
      when a graceful deletion is requested. Read-only. More info: http://releases.k8s.io/HEAD/docs/devel/api-conventions.md#metadata*/
     ...
     Populated by
      the system. Read-only. Null for lists. More info: http://releases.k8s.io/HEAD/docs/devel/api-conventions.md#metadata*/
