...
::orch "kubernetes" "Toleration" as Toleration @operator, @key, @tolerationSeconds, @effect, @value {
     /**Operator represents a key's relationship to the value. Valid operators are Exists and Equal.
      Defaults to Equal. Exists is equivalent to wildcard for value, so that a pod can tolerate
