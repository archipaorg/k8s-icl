...
::orch "kubernetes" "APIServiceSpec" as APIServiceSpec @version, @group, @service, @caBundle, @groupPriorityMinimum, @insecureSkipTLSVerify, @versionPriority {
     ...
     /**GroupPriorityMininum is the priority this group should have at least. Higher priority means
      that the group is prefered by clients over lower priority ones. Note that other versions
      ...
      like: *.k8s.io (except extensions) at 18000 and PaaSes (OpenShift, Deis) are recommended
      to be in the 2000s*/
     groupPriorityMinimum = null,
     ...
     /**VersionPriority controls the ordering of this API version inside of its group.  Must be
      ...
      (20 before 10). The secondary sort is based on the alphabetical comparison of the name
      of the object.  (v1.bar before v1.foo) Since it's inside of a group, the number can be
      small, probably in the 10s.*/
     versionPriority = null,
