...
::orch "kubernetes" "PersistentVolumeSpec" as PersistentVolumeSpec @photonPersistentDisk, @persistentVolumeReclaimPolicy, @azureDisk, @portworxVolume, @glusterfs, @claimRef, @scaleIO, @cinder, @flocker, @storageClassName, @quobyte, @rbd, @capacity, @accessModes, @iscsi, @storageos, @fc, @nfs, @gcePersistentDisk, @hostPath, @flexVolume, @awsElasticBlockStore, @cephfs, @local, @azureFile, @vsphereVolume {
