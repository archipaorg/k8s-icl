...
::orch "kubernetes" "NodeAffinity" as NodeAffinity @requiredDuringSchedulingIgnoredDuringExecution, @preferredDuringSchedulingIgnoredDuringExecution {
     /**The scheduler will prefer to schedule pods to nodes that satisfy the affinity expressions
      ...
      and adding "weight" to the sum if the node matches the corresponding matchExpressions;
