take sessionaffinityconfig

/**ServiceSpec describes the attributes that a user creates on a service.*/
::orch "kubernetes" "ServiceSpec" as ServiceSpec @loadBalancerIP, @loadBalancerSourceRanges, @externalIPs, @externalTrafficPolicy, @healthCheckNodePort, @selector, @externalName, @sessionAffinity, @clusterIP, @sessionAffinityConfig, @type, @ports, @publishNotReadyAddresses {
     ...
     /**publishNotReadyAddresses, when set to true, indicates that DNS implementations must publish
      ...
      value is false. The primary use case for setting this field is to use a StatefulSet's Headless
      Service to propagate SRV records for its Pods without respect to their readiness for purpose
