...
::orch "kubernetes" "EndpointSubset" as EndpointSubset @notReadyAddresses, @ports, @addresses {
     /**IP addresses which offer the related ports but are not currently marked as ready because
      they have not yet finished starting, have recently failed a readiness check, or have recently
