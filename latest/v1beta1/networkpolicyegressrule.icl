...
::orch "kubernetes" "NetworkPolicyEgressRule" as NetworkPolicyEgressRule @to, @ports {
     /**List of destinations for outgoing traffic of pods selected for this rule. Items in this
      ...
      present and contains at least one item, this rule allows traffic only if the traffic matches
      at least one item in the to list.*/
     to = null,
     /**List of destination ports for outgoing traffic. Each item in this list is combined using
      a logical OR. If this field is empty or missing, this rule matches all ports (traffic not
